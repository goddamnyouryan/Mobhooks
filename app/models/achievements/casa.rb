class Casa < Achievement
  ...
  # Comment out below for once-off achievements
   def self.award_achievements_for(user)
     ...
     achievement = Achievement.new(:user => user, :kind => "Casa", :level => nil)
     achievement.save!
   end
   ...
   def self.small_image
    'badges/small/casa.jpg'
   end
   
   def self.description
   	'Submitting a Real Estate campaign will earn you this badge'
   end
