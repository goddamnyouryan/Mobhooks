class Charity < Achievement
  ...
  # Comment out below for once-off achievements
   def self.award_achievements_for(user)
     ...
     achievement = Achievement.new(:user => user, :kind => "Charity", :level => nil)
     achievement.save!
   end
   ...
   def self.small_image
    'badges/small/charity.jpg'
   end
   
   def self.description
   	'Submit a campaign for a Non-Profit if you want to earn the Charity Badge.'
   end
