class Fatico < Achievement
  ...
  # Comment out below for once-off achievements
   def self.award_achievements_for(user)
     ...
     achievement = Achievement.new(:user => user, :kind => "Fatico", :level => nil)
     achievement.save!
   end
   ...
   def self.small_image
    'badges/small/fatico.jpg'
   end
   
   def self.description
   	'Submitting a campaign for a food brand will earn you this badge'
   end   
