class Dapper < Achievement
  ...
  # Comment out below for once-off achievements
   def self.award_achievements_for(user)
     ...
     achievement = Achievement.new(:user => user, :kind => "Dapper", :level => nil)
     achievement.save!
   end
   ...
   def self.small_image
    'badges/small/dapper.jpg'
   end
   
   def self.description
   	'Submit a text campaign for retail to get this badge!'
   end
