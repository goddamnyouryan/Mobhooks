class Teamster < Achievement
  ...
  # Comment out below for once-off achievements
   def self.award_achievements_for(user)
     ...
     achievement = Achievement.new(:user => user, :kind => "Teamster", :level => nil)
     achievement.save!
   end
   ...
   def self.small_image
    'badges/small/teamster.jpg'
   end
   
   def self.description
   	'Submitting a campaign for Public Services to get this badge.'
   end
