class BootLeg < Achievement
  ...
  # Comment out below for once-off achievements
   def self.award_achievements_for(user)
     ...
     achievement = Achievement.new(:user => user, :kind => "BootLeg", :level => nil)
     achievement.save!
   end
   ...
   def self.small_image
    'badges/small/bootleg.jpg'
   end
   
   def self.description
   	'Submit a text campaign for a bar or other nightlife to get this badge!'
   end
