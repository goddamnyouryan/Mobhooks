class Bookie < Achievement
  ...
  # Comment out below for once-off achievements
   def self.award_achievements_for(user)
     ...
     achievement = Achievement.new(:user => user, :kind => "Bookie", :level => nil)
     achievement.save!
   end
   ...
   def self.small_image
    'badges/small/bookie.jpg'
   end
   
    def self.description
   	'Submit a casino based text campaign to get this badge.'
   end
