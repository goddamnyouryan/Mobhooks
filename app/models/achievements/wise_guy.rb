class WiseGuy < Achievement
  ...
  # Comment out below for once-off achievements
   def self.award_achievements_for(user)
     ...
     achievement = Achievement.new(:user => user, :kind => "WiseGuy", :level => nil)
     achievement.save!
   end
   ...
   def self.small_image
    'badges/small/wiseguy.jpg'
   end
   
   def self.description
   	'Submit a capaign for an education or training institution to earn this badge.'
   end
