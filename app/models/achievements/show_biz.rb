class ShowBiz < Achievement
  ...
  # Comment out below for once-off achievements
   def self.award_achievements_for(user)
     ...
     achievement = Achievement.new(:user => user, :kind => "ShowBiz", :level => nil)
     achievement.save!
   end
   ...
   def self.small_image
    'badges/small/showbiz.jpg'
   end
   
   def self.description
   	'Submit a Music or Movie campaign to earn the Show Biz badge'
   end
