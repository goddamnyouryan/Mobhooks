class Street < Achievement
  ...
  # Comment out below for once-off achievements
   def self.award_achievements_for(user)
     ...
     achievement = Achievement.new(:user => user, :kind => "Street", :level => nil)
     achievement.save!
   end
   ...
   def self.small_image
    'badges/small/street.jpg'
   end
   
    def self.description
   	'Submitting a campaign for a local event to earn this badge.'
   end
