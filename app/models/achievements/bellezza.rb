class Bellezza < Achievement
  ...
  # Comment out below for once-off achievements
   def self.award_achievements_for(user)
     ...
     achievement = Achievement.new(:user => user, :kind => "Bellezza", :level => nil)
     achievement.save!
   end
   ...
   def self.small_image
    'badges/small/bellezza.jpg'
   end
   
   def self.description
   	'To obtain this badge, submit a beauty campaign.'
   end
