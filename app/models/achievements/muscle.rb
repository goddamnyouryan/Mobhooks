class Muscle < Achievement
  ...
  # Comment out below for once-off achievements
   def self.award_achievements_for(user)
     ...
     achievement = Achievement.new(:user => user, :kind => "Muscle", :level => nil)
     achievement.save!
   end
   ...
   def self.small_image
    'badges/small/muscle.jpg'
   end
   
   def self.description
   	'Submit a Spa or Fitness campaign to get this badge!'
   end
