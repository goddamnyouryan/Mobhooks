class Giardino < Achievement
  ...
  # Comment out below for once-off achievements
   def self.award_achievements_for(user)
     ...
     achievement = Achievement.new(:user => user, :kind => "Giardino", :level => nil)
     achievement.save!
   end
   ...
   def self.small_image
    'badges/small/giardino.jpg'
   end
   
   def self.description
   	'Submitting a Home and Garden text campaign to earn this badge.'
   end
