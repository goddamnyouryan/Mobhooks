class ChopShop < Achievement
  ...
  # Comment out below for once-off achievements
   def self.award_achievements_for(user)
     ...
     achievement = Achievement.new(:user => user, :kind => "ChopShop", :level => nil)
     achievement.save!
   end
   ...
   def self.small_image
    'badges/small/chopshop.jpg'
   end
   
   def self.description
   	'To obtain this badge, submit an automotive text campaign.'
   end
