class CampaignsController < ApplicationController
  ...
  def index
    if params[:search] == "Search for an Offer..." && params[:near] && params[:distance]
      ...
      @campaigns = Campaign.location_search(params[:search], params[:near], params[:distance]) | Campaign.find_tagged_with(params[:search], :origin => params[:near], :within => params[:distance]) | Campaign.brand_search(params[:search]) | Campaign.chain_search(params[:chain])
    elsif params[:search] && params[:near] == ""
      @campaigns = Campaign.search(params[:search]) | Campaign.find_tagged_with(params[:search])  | Campaign.brand_search(params[:search]) | Campaign.chain_search(params[:chain])
    elsif params[:search] && params[:near]
      @campaigns = Campaign.location_search(params[:search], params[:near], 25) | Campaign.find_tagged_with(params[:search], :origin => params[:near], :within => 25)  | Campaign.brand_search(params[:search]) | Campaign.chain_search(params[:chain])
    elsif params[:search] || params[:near] == ""
      @campaigns = Campaign.search(params[:search]) | Campaign.find_tagged_with(params[:search])  | Campaign.brand_search(params[:search]) | Campaign.chain_search(params[:chain])
    else
      @campaigns = Campaign.find(:all, :limit => 25)
